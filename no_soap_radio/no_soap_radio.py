...
mode_choice1 = tk.Radiobutton(mode_frame, text="Receive", variable=mode, value="Rx",
                              command=select_mode, indicatoron=0, font=(None, 18), width=10).grid(column=2, row=1, columnspan=2, sticky='W')
...
frequency_entry = tk.Entry(frequency_frame, textvariable=frequency, width=10, font=(None, 18), justify=tk.CENTER).grid(column=0, row=1, columnspan=2, sticky='W')
...
radio_type_frame.grid(column=0, row=4, rowspan=3, columnspan=6, pady=10)
