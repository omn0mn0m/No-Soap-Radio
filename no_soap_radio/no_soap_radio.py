...
start_button = tk.Radiobutton(mode_frame, text="Start", variable=enabled, value=True,
                              command=start, indicatoron=0, font=(None, 32), width=15).grid(column=0, row=2, columnspan=2, sticky='W')
stop_button = tk.Radiobutton(mode_frame, text="Stop", variable=enabled, value=False,
                             command=stop, indicatoron=0, font=(None, 32), width=15).grid(column=2, row=2, columnspan=2, sticky='W')
...
frequency_entry = tk.Entry(frequency_frame, textvariable=frequency, width=13, font=(None, 32), justify=tk.CENTER).grid(column=0, row=1, columnspan=2, sticky='W')


unit_choice0 = tk.Radiobutton(frequency_frame, text="Hz", variable=unit, value="Hz",
                              command=select_unit, indicatoron=0, font=(None, 32), width=8).grid(column=2, row=1, sticky='W')
unit_choice1 = tk.Radiobutton(frequency_frame, text="kHz", variable=unit, value="kHz",
                              command=select_unit, indicatoron=0, font=(None, 32), width=8).grid(column=3, row=1, sticky='W')
unit_choice2 = tk.Radiobutton(frequency_frame, text="MHz", variable=unit, value="MHz",
                              command=select_unit, indicatoron=0, font=(None, 32), width=8).grid(column=4, row=1, sticky='W')
unit_choice3 = tk.Radiobutton(frequency_frame, text="GHz", variable=unit, value="GHz",
                              command=select_unit, indicatoron=0, font=(None, 32), width=8).grid(column=5, row=1, sticky='W')

frequency_scale = tk.Scale(frequency_frame, variable=frequency, from_=0, to=999, orient=tk.HORIZONTAL, width=40, length=1240, sliderlength=60, resolution=0.1, font=(None, 32)).grid(column=0, row=2, columnspan=6, sticky='W')
